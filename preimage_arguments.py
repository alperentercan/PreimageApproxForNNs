#########################################################################
##   This file is to set arguments of CROWN (alpha-beta-CROWN)         ##
##                                                                     ##
##                                                                     ##
##                                                                     ##
...
NOTE follow CROWN arguments config instructions
...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        self.add_argument('--config', type=str, default=None, help='Path to YAML format config file.', hierarchy=None)
        ...
        self.add_argument("--sample_optim", type=int, default=1000,
                          help='Sample size for local optimization.', hierarchy=h + ["sample_optim"])
        ...
        self.add_argument("--csv_name", type=str, default='instances.csv',
        ...
        h = ["model"]
        self.add_argument("--model", type=str, default= 'Customized(\"custom_model_data\", \"two_relu_toy_model\", in_dim=2, out_dim=2)', help='Model name. Will be evaluated as a python statement.',
                          hierarchy=h + ["name"])
        ...
        self.add_argument("--norm", type=float, default='inf',
                          ...
                          hierarchy=h + ["norm"])
        self.add_argument("--epsilon", type=float, default=1,
        ...
        h = ["solver"]
        self.add_argument("--batch_size", type=int, default=500,
        ...
        self.add_argument('--bound_prop_method', default="crown",
        ...
        self.add_argument('--no_alpha', action='store_false', dest='alpha', help='Disable/Enable alpha crown.',
                          hierarchy=h + ["alpha"])
        self.add_argument("--lr_init_alpha", type=float, default=0.2,
                          help='Learning rate for the optimizable parameter alpha in alpha-CROWN bound.',
                          hierarchy=h + ["lr_alpha"])
        self.add_argument('--init_iteration', type=int, default=30,
        ...
        self.add_argument("--lr_alpha", type=float, default=0.01,
                          ...
                          hierarchy=h + ["lr_alpha"])
        self.add_argument("--lr_beta", type=float, default=0.03,
        ...
        h = ["solver", "mip"]
        self.add_argument('--mip_multi_proc', type=int, default=8,
        ...
        self.add_argument('--mip_threads', type=int, default=4,
        ...
        self.add_argument("--timeout", type=float, default=3600,
        ...
        h = ["bab", "branching"]
        self.add_argument("--branching_method", default="sb",
                          ...
                          hierarchy=h + ["method"])
        self.add_argument("--branching_candidates", type=int, default=5,
        ...
        self.add_argument("--enable_input_split", action='store_false',
        ...
        self.add_argument("--input_split_enhanced_bound_patience", type=int, default=20,
        ...
        self.add_argument("--input_split_attack_patience", type=int, default=80,
        ...
        # NOTE argument for iteration limit (iteration*2)
        self.add_argument("--input_split_budget", type=int, default=10000,
                          help='After the number of visited nodes, we will stop the input split.',
